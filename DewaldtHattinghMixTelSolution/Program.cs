...
namespace DewaldtHattinghMixTelSolution
{
    internal abstract class Program
    {
        private static void Main()
        {
            ...
            List<VehiclePositionData> vehiclePositions = DataInterpreter.ParseData();
        ...
        private static int IdentifyClosestPosition(Coordinate geoCoordinate, List<VehiclePositionData> vehiclePositions)
        {
            ...
            while (lowerBound <= upperBound)
            {
                ...
                var distance = ComputeDistance(geoCoordinate.Latitude, geoCoordinate.Longitude,
                                               vehiclePositions[median].Latitude,
